package com.movile.next.seriestracker.activities.database.manual.provider;
...
import com.movile.next.seriestracker.activities.database.manual.SeriesTrackerDbHelper;
